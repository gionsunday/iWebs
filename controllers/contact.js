...
const newMessage = async (req, res) => { 
    ...
    <p style="text-align:left !important; color:black; background-color: inherit;">Message: <strong>${message}</strong> </p> 
        ...
        const mailOptions2 = { 
            ...
            <div style="text-align:left; min-height:100%; padding:20px"> 
              <h1 style="color:white; text-align: center; padding: 10px; border-radius:20px; text-shadow:0px 11px 5px rgb(148, 132, 88);background: linear-gradient(105deg, rgba(91,104,235,1) 0%, rgba(40,225,253,1) 100%); border-radius: 10px;"> <strong>iWebs</strong> </h1> 
             <h2 style="color:#afafaf">Hi <strong style="font-family:comic san ms, cursive;">${name}</strong></h2> 
            <p style="padding:10px;  text-alig:left !important; color:#000; background-color: inherit; font-weight:400">We got your message, we will respond accordingly. <br/> <br/>Thank you!</p> 
